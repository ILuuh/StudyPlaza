...
function showFinalResult() {
    ...
    resultEl.innerHTML = `
        ...
        <p>🚀 Quer desafios personalizados? <a href="cadastro.html" style="color: #ffff; font-weight: bold;">Cadastre-se agora</a> e explore quizzes completos!</p>
    `;
